    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rus.category_product')),
            ],
        ),
        migrations.CreateModel(
            name='Certificats',
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rus.category_certificat')),
            ],
        ),
    ]
